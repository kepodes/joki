...
<body>
    <main class="flex flex-col">
        ...
        <nav class="bg-black border-gray-200">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
                    <img src="{{asset('img/logo_arceus.png')}}" class="h-10" alt="Arceus Logo" />
                ...
                <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
                    <ul
                        ...
                        <li>
                            <a href="/"
                                class="{{Request::is('/')? 'md:text-blue-700 md:dark:text-blue-500 bg-blue-700' : 'md:hover:text-blue-700 text-white hover:bg-gray-500'}} md:p-0 text-white block py-2 px-3 rounded md:hover:bg-transparent md:bg-transparent"
                                aria-current="page"><i class="fas fa-home"></i> Beranda</a>
                        </li>
                        <li>
                            <a href="/riwayat"
                                class="{{Request::is('riwayat')? 'md:text-blue-700 md:dark:text-blue-500 bg-blue-700' : 'md:hover:text-blue-700 text-white hover:bg-gray-500'}} text-white block py-2 px-3 rounded md:bg-transparent md:hover:bg-transparent md:p-0"><i class="fas fa-history"></i> Riwayat
                                Transaksi</a>
                        </li>
                        <li>
                            <a href="/login"
                                class="{{Request::is('login')? 'md:text-blue-700 md:dark:text-blue-500 bg-blue-700' : 'md:hover:text-blue-700 text-white hover:bg-gray-500'}} text-white block py-2 px-3 rounded md:bg-transparent md:hidden md:hover:bg-transparent md:p-0"><i class="fas fa-sign-in-alt"></i> 
                            Login</a>
                        </li>
                    </ul>
                </div>
        ...
        <footer class="bg-black">
            <section class="grid grid-cols-1 xl:grid-cols-4 pt-3 px-10 text-sm" >
                <section class="flex flex-col" >
                    <img class="h-auto w-32" src="{{asset("img/logo_arceus.png")}}" alt="">
